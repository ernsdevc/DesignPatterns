...
namespace DesignPattern.Decorator.Controllers
{
    public class DefaultController : Controller
    {
        ...
        {
            CreateNewMessage createNewMessage = new CreateNewMessage();
            EncryptBySubjectDecorator encryptBySubjectDecorator = new EncryptBySubjectDecorator(createNewMessage);
            encryptBySubjectDecorator.SendMessageByEncryptSubject(message);
            return View();
        }
